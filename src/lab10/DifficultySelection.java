 ...
 * @author Gehad
 */
public class DifficultySelection extends javax.swing.JFrame {

    /**
     * Creates new form DifficultySelection
     */
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       String level = cmbDifficulty.getSelectedItem().toString().toLowerCase();

SudokuBoard board = null;
        try {
            board = GameLoader.loadGame(level);
        } catch (IOException ex) {
            Logger.getLogger(DifficultySelection.class.getName()).log(Level.SEVERE, null, ex);
        }
...
this.dispose(); // close the current form
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DifficultySelection.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
